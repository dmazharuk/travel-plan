...
//   // };
//   const getRandomColor = () => {
//     const hue = Math.floor(Math.random() * 360); // Тон (0-359)
//     const saturation = 30 + Math.floor(Math.random() * 20); // Насыщенность (30-49%)
//     const lightness = 80 + Math.floor(Math.random() * 10); // Светлота (80-89%)
//     return `hsl(${hue}, ${saturation}%, ${lightness}%)`;
//   };
